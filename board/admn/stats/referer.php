...
$counter = GetCounter("REFERER", $searchSDate, $searchEDate);
$list = $counter['list'];
?>
						...
						<tr>
							<td style="padding-top:20px;" align="center">
								...
								for($i=0;$i<sizeOf($list);$i++){
									if($list[$i]['visitReferer'] == 'INPUT')	$text = $i+1; //"직접입력";
									else										$text = $i+1; //$text = $list[$i]['visitReferer'];

									$grpData[$i]['title'] = $text;
							...
							<td>
								<table width='100%' border='0' cellspacing='0' cellpadding='0'>
									...
									<tr height='30'>
										...
										<td align='center'>유입URL</td>
										<td align='center'>유입수</td>
										<td align='center'>비율</td>
									</tr>
									<tr height='1' bgcolor='#0c1735'><td colspan='6'></td></tr>
								<?
									for($i=0;$i<sizeOf($list);$i++){
										if($list[$i]['visitReferer'] == 'INPUT')	$text = "직접입력";
										else										$text = $list[$i]['visitReferer'];
								...
								?>
									<tr height='30'>
										...
										<td align='left' style='padding-left:10px;'><?=$text?></td>
