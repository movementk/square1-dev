						...
						<tr>
							<td style="padding-top:20px;" align="center">
								...
								for($i=0;$i<sizeOf($list);$i++){
									$grpData[$i]['title'] = $list[$i]['visitAgentName'];
							...
							<td>
								<table width='100%' border='0' cellspacing='0' cellpadding='0'>
									...
									<tr height='30'>
										...
										<td align='center'>브라우저(스마트폰) 종류</td>
								...
								?>
									<tr height='30'>
										...
										<td align='left' style='padding-left:10px;'><?=$list[$i]['visitAgentName']?></td>
