...
<div id="container">
	<div class="content_view">
		...
		<textarea style="width:100%;height:450px;" name="agree1" id="agree1" ><?=$row["agree1"]?></textarea>
...
function board_check(){
	...
	oEditors.getById["agree1"].exec("UPDATE_CONTENTS_FIELD", []);
	f.submit();
}
</script>
<?
