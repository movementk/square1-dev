	...
	document.write("<style>.calendar {background:buttonface;padding:5;border:1 solid buttonshadow;width:210;display:none;position: absolute;z-index: 99;}.celDate {background:white;cursor:Hand;border:1px solid white;}</style>");

	document.write("<div id=minical oncontextmenu='return false' ondragstart='return false' onselectstart='return false' class='calendar'></div>");
...
function Show_cal(sYear, sMonth, sDay) {
	...
	Cal_HTML = "<table border=1><tr><td><TABLE WIDTH=200 BORDER=0 CELLPADDING=0 CELLSPACING=0 ONMOUSEOVER=doOver(); ONMOUSEOUT=doOut(); STYLE='font-size:8pt;font-family:Tahoma;'>"
