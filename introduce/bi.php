                ...
                <section class="bi-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-lg-9">
                            <div class="details">
                                <p>
                                    스퀘어원의 시그니처는 심볼마크와 로고 타입의 조합으로 스퀘어원의 이미지를 담고 있습니다.<br>
                ...
                <section class="bi-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-lg-9">
                            <div class="details">
                                <p>
                                    스퀘어원의 심볼마크는 다양한 라이프스타일의 시너지를 이루는 유통 허브의 기업 이미지를 표현합니다. 각각의 컬러는 열정(RED), 신뢰(BLUE), 에너지 (ORANGE), 풍요로운 라이프스타일(GREEN)을 상징하며 ㈜서부 T&amp;D의 기업 정신을 발전 계승하였습니다. 
                                </p>
                            </div>
                            <div class="figure">
                                <p>
